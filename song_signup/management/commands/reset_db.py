...
from song_signup.models import SongRequest, Singer, CurrentGroupSong, GroupSongRequest, TicketOrder
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        for ticket in TicketOrder.objects.all():
            ticket.save_customers()
