...
CONSTANCE_ADDITIONAL_FIELDS = {
    'EVENING_TYPE_SELECT': [
        ...
        {
            'choices': (('open_mic', 'Open Mic'), ('pub_quiz', 'Pub Quiz')),
...
CONSTANCE_CONFIG = {
    ...
    'EVENT_SKU': ('', "The SKU of this evening's event (Generated by Lineapp) - REQUIRED TO OPEN APP"),
    ...
    'EVENING_TYPE': ('open_mic', "Type of evening: root URL shows this page", 'EVENING_TYPE_SELECT'),
}
